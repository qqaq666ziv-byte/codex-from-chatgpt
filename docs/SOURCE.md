...
AutoDev 0.4.2 從 joseanu/codex-from-chatgpt 0.3.1 延伸；原已驗證基準為 `cc18c408f1431336f4ba673c4d26c81b68aa4f91`，本輪接續 0.4.1 `cb7fc90490570a3ad0ae4cd79c50a3ae90115105`，兩者歷史均保留。
...
- 0.4.2 核心套件版本不變，新增獨立 `edge` 開發工具 **Wrangler 4.129.0** 與 lockfile。只用本地固定 CLI；部署／檢查不隱式下載工具，私有 CLI home 與明確空 env file 隔離環境秘密。Worker 使用原生 WebCrypto，沒有第三方 runtime dependency。
